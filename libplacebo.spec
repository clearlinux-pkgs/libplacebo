...
%prep
%setup -q -n libplacebo-4.157.0
cd %{_builddir}/libplacebo-4.157.0
...
cp %{_builddir}/libplacebo-4.157.0/LICENSE %{buildroot}/usr/share/package-licenses/libplacebo/7fab4cd4eb7f499d60fe183607f046484acd6e2d
cp %{_builddir}/libplacebo-4.157.0/demos/LICENSE %{buildroot}/usr/share/package-licenses/libplacebo/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
