...
Version  : 4.192.1
Release  : 20
URL      : https://github.com/haasn/libplacebo/archive/v4.192.1/libplacebo-4.192.1.tar.gz
Source0  : https://github.com/haasn/libplacebo/archive/v4.192.1/libplacebo-4.192.1.tar.gz
...
%prep
%setup -q -n libplacebo-4.192.1
cd %{_builddir}/libplacebo-4.192.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643917393
...
cp %{_builddir}/libplacebo-4.192.1/LICENSE %{buildroot}/usr/share/package-licenses/libplacebo/7fab4cd4eb7f499d60fe183607f046484acd6e2d
cp %{_builddir}/libplacebo-4.192.1/demos/LICENSE %{buildroot}/usr/share/package-licenses/libplacebo/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
